...
export default function HmFilterSortCopy() {
  ...
  return (
    <div className="max-w-[1440px] mx-auto px-4 pt-24 pb-10 font-sans">
      {/* Filter + Sort Bar */}
      <div className="flex justify-between items-center mb-4 sticky top-20 bg-white z-30 py-3">
        <button
          onClick={() => setFilterOpen(true)}
          className="flex items-center gap-2 border border-black px-3 py-2 text-sm uppercase hover:bg-black hover:text-white transition"
        >
          <FaFilter />
          Filter
        </button>
        ...
        <select
          ...
          className="border border-black px-3 py-2 text-sm bg-white focus:outline-none"
        >
